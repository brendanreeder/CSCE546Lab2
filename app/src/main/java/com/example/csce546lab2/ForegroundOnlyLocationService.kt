...
import com.example.csce546lab2.MapsActivity
import com.example.csce546lab2.R
import com.example.csce546lab2.SharedPreferenceUtil
import com.example.csce546lab2.toText
        ...
        try {
            ...
            removeTask.addOnCompleteListener() { task ->
                if(task.isSuccessful) {
                    ...
                    Log.d(TAG, "Failedd to remove Location Callback.")
                }
            }
